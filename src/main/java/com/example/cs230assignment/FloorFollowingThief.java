...
class FloorFollowingThief extends NPC {
   ...
   * @param allocatedColourPass the colour the floorfollowing thief is required to follow
  ...
  private Boolean validMove() {
    ...
    for (int i = 0; i <= 4; i++) {
      //checks to see if it has checked all directions else sets direction to stay on square
      if (i != 4) {
        //checks to see if there is a tile to the right side of the board of the thief
        if ((super.coordChange[0] == 1 && super.coordChange[1] == 0)
            ...
            if (super.getCurrentBoard()
              ...
              if(!(super.getCurrentBoard().getTile
              (super.getXCoord(), super.getYCoord() + 1).getEntity() != null)) {
                //checks to see if the entity on the tile is one that will block movement
                // if not the valid move has been found
                // if it is check another direction
                switch(super.currentBoard.getTile(super.getXCoord(), super.getYCoord() + 1).getEntity().getEntityName()){
                  case("Gate"):
        ...
        //checks to see if there is a valid move up from the 
          ...
          if (super.getCurrentBoard()
            ...
            if(!(super.getCurrentBoard().getTile
              ...
              //else breaks out of the loop as the correct direction has been found
              switch(super.currentBoard.getTile(super.getXCoord(), super.getYCoord() + 1).getEntity().getEntityName()){
                case("Gate"):
                case("FloorFollowingThief"):
                case("FlyingAssassin"):
            ...
            //valid move breaks out of loop as correct direction has been found
            }else {
                i = 5;
            } 
        ...
        //checks left of the thief on the board for a valid move
            ...
            if (super.getCurrentBoard()
              ...
              if(!(super.getCurrentBoard().getTile
              (super.getXCoord(), super.getYCoord() + 1).getEntity() != null)) {
                //checks to see if there is an entity on the tile that blocks movement
              ...
              //valid move break out of loop as correct direction has been found
              }else {
                  i = 5;
              } 
        ...
        //checks below the thief on the board for a valid move
            ...
            && super.getYCoord() != 0) {
              ...
              //valid move breaks out of loop as the correct direction has been found
              }else {
                  i = 5;
              } 
